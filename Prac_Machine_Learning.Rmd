...
---
## Introduction
This is document describes the analysis I conducted for my final project for the Johns Hopkins' Coursera course "Practical Machine Learning" in the Data Science specialization. All of my work was conducted in [RStudio](http://www.rstudio.com).  
...
proc.time() - ptm
```
To capture the execution time I've used `ptm` and `proc.time()`.  On my 2013 iMac the execution time was roughly 20 minutes.
```{r}
print(modFit)
